      ...
      <div className="projects-section">
        ...
        <div className="projects-grid">
          <div className="experience-item card">
            ...
            <p className="experience-subtitle">한국로봇산업협회 | 고용노동부</p>
          ...
          <div className="experience-item card">
            <div className="project-title-row">
              <h4><Link to="/project/virtual-hot-cell" className="project-detail-link">Virtual Hot Cell Facility Implementation</Link></h4>
          ...
          <div className="experience-item card">
            <div className="project-title-row">
              <h4><Link to="/project/autonomous-driving" className="project-detail-link">Autonomous Driving Assistant Robot</Link></h4>
            ...
            <p className="experience-subtitle">Hanyang ERICA University</p>
