      ...
      <div className="main-layout">
        <div className="main-column">
          ...
          <div className="projects-section card">
            <h3>Projects</h3>
            <div className="experience-item">
              <h4><a href="https://github.com/PolyGon-13/Smart_Rescue_Mat" target="_blank" rel="noreferrer" className="project-link">Smart Rescue Mat</a></h4>
            ...
            <hr className="divider" />
            <div className="experience-item">
              <h4><a href="https://github.com/PolyGon-13/PiPER_Unity_VR" target="_blank" rel="noreferrer" className="project-link">Agilex PiPER VR Hand Tracking</a></h4>
              <p className="experience-date">2025.09 - 2025.10</p>
            </div>
            <hr className="divider" />
            <div className="experience-item">
              <h4><a href="https://github.com/PolyGon-13/Digital_Twin-Pyro_Process_Mockup.git" target="_blank" rel="noreferrer" className="project-link">Virtual Hot Cell Facility Implementation</a></h4>
              <p className="experience-subtitle">Unity VR and PLC Integration (KAERI)</p>
              <p className="experience-date">2025.08 - 2025.10</p>
            </div>
            <hr className="divider" />
            <div className="experience-item">
              <h4><a href="https://github.com/PolyGon-13/Basic_Robotics_Experiment.git" target="_blank" rel="noreferrer" className="project-link">Autonomous Driving Assistant Robot</a></h4>
